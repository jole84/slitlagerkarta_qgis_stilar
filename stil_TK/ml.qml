...
<qgis simplifyDrawingHints="1" simplifyMaxScale="1" simplifyLocal="1" version="3.16.3-Hannover" labelsEnabled="0" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" minScale="100000" simplifyDrawingTol="1" styleCategories="AllStyleCategories" maxScale="0" readOnly="0">
  <flags>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{28422f00-9fb7-40fb-aeea-52010ca5a631}">
      <rule symbol="0" label="Diffus Strandlinje" key="{28291430-0c4d-47be-867a-6d79783735f1}" filter="strpos(&quot;kategori&quot;, 'V.yta dif. Str')>0 OR left(&quot;kategori&quot;,10)='Skog - Vat'"/>
      <rule symbol="1" label="Vattenlinje" key="{5073df70-e520-4e01-8609-7ee6e86ad407}" filter="left(&quot;kategori&quot;,6)='Vatten' AND substr(&quot;kategori&quot;,11,3)&lt;>'- V'"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0" force_rhr="0">
        <layer class="SimpleLine" pass="0" locked="0" enabled="1">
          ...
          <prop v="33,175,249,255" k="line_color"/>
