...
<qgis readOnly="0" maxScale="0" minScale="100000" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="1" version="3.12.2-București" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" labelsEnabled="0">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 forceraster="0" type="categorizedSymbol" enableorderby="0" symbollevels="1" attr="kategori">
    <categories>
      <category value="Industrispår/museijärnväg" label="Industrispår/museijärnväg" render="true" symbol="0"/>
      <category value="Järnväg i underfart" label="Järnväg i underfart" render="true" symbol="1"/>
      <category value="Järnväg med dubbelspår, elektrifierad" label="Järnväg med dubbelspår, elektrifierad" render="true" symbol="2"/>
      <category value="Järnväg med enkelspår, ej elektrifierad" label="Järnväg med enkelspår, ej elektrifierad" render="true" symbol="3"/>
      <category value="Järnväg med enkelspår, elektrifierad" label="Järnväg med enkelspår, elektrifierad" render="true" symbol="4"/>
      <category value="Järnväg under byggnad (byggnation)" label="Järnväg under byggnad (byggnation)" render="true" symbol="5"/>
      <category value="Järnväg, före detta" label="Järnväg, före detta" render="true" symbol="6"/>
      <category value="Smalspårig ej elektrifierad järnväg" label="Smalspårig ej elektrifierad järnväg" render="true" symbol="7"/>
      <category value="Smalspårig elektrifierad järnväg med dubbelspår" label="Smalspårig elektrifierad järnväg med dubbelspår" render="true" symbol="8"/>
      <category value="Smalspårig elektrifierad järnväg med enkelspår" label="Smalspårig elektrifierad järnväg med enkelspår" render="true" symbol="9"/>
      <category value="Spårväg, tunnelbana" label="Spårväg, tunnelbana" render="true" symbol="10"/>
      <category value="" label="" render="true" symbol="11"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="10" type="line">
        ...
        <layer locked="0" enabled="1" class="MarkerLine" pass="0">
          ...
          <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="@10@1" type="marker">
            <layer locked="0" enabled="1" class="SimpleMarker" pass="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="122,153,224,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
