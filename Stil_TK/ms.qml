...
<qgis readOnly="0" maxScale="-4.656612873077393e-10" minScale="100000000" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" version="3.12.2-București" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" labelsEnabled="0">
  ...
  <renderer-v2 forceraster="0" type="categorizedSymbol" enableorderby="0" symbollevels="0" attr="KATEGORI">
    <categories>
      <category value="Sankmark, normal" label="Sankmark, normal" render="true" symbol="0"/>
      <category value="Sankmark, svrframkomlig" label="Sankmark, svrframkomlig" render="true" symbol="1"/>
      <category value="Sankmark, torvtkt" label="Sankmark, torvtkt" render="true" symbol="2"/>
    ...
    <symbols>
      ...
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="1" type="fill">
        <layer locked="0" enabled="1" class="LinePatternFill" pass="0">
          ...
          <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="@1@0" type="line">
            <layer locked="0" enabled="1" class="SimpleLine" pass="0">
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="2" type="fill">
        <layer locked="0" enabled="1" class="LinePatternFill" pass="0">
          ...
          <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="@2@0" type="line">
            <layer locked="0" enabled="1" class="SimpleLine" pass="0">
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="3" type="fill">
        <layer locked="0" enabled="1" class="LinePatternFill" pass="0">
          ...
          <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="@3@0" type="line">
            <layer locked="0" enabled="1" class="SimpleLine" pass="0">
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
