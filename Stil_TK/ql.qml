...
<qgis readOnly="0" maxScale="0" minScale="100000000" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" version="3.12.2-București" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" labelsEnabled="0">
  ...
  <renderer-v2 forceraster="0" type="categorizedSymbol" enableorderby="0" symbollevels="0" attr="KATEGORI">
    <categories>
      <category value="Militärt skjutfält" label="Militärt skjutfält" render="true" symbol="0"/>
      <category value="Militärt skjutfält, sammanfallande med annan gräns" label="Militärt skjutfält, sammanfallande med annan gräns" render="true" symbol="1"/>
      <category value="Militärt övningsfält" label="Militärt övningsfält" render="true" symbol="2"/>
      <category value="Militärt övningsfält, sam.fall. med annan gräns" label="Militärt övningsfält, sam.fall. med annan gräns" render="true" symbol="3"/>
    ...
    <symbols>
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="0" type="line">
        <layer locked="0" enabled="1" class="SimpleLine" pass="0">
          ...
          <prop k="line_color" v="27,156,231,255"/>
      ...
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="4" type="line">
        <layer locked="0" enabled="1" class="SimpleLine" pass="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="205,84,161,255"/>
          <prop k="line_style" v="dash"/>
          <prop k="line_width" v="35"/>
          <prop k="line_width_unit" v="MapUnit"/>
          <prop k="offset" v="0"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="&quot;KATEGORI&quot;">
    <columns>
      <column hidden="0" width="-1" name="KKOD" type="field"/>
      <column hidden="0" width="215" name="KATEGORI" type="field"/>
